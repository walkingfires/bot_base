...
from bot.users.keybords.keyboards import simptoms_keyboard, calendar_keyboard, calendar_page_keyboard, control_keyboard, \
    control_subject_keyboard, control_error_keyboard
